...
def Plot_Maximo_Mes(mapa_final,fecha,duplas=None,n_report=''):
...
def report(start, end):
    ...
    pdf.drawImage(save_path + 'Resumen_semana_%s_%s.png'%(start.strftime('%Y%m%d'), end.strftime('%Y%m%d')),660,180 ,width=420,preserveAspectRatio=True)
